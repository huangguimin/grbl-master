...
#define SPINDLE_ENABLE_PIN    PINB
// Z Limit pin and spindle PWM/enable pin swapped to access hardware PWM on Pin 11.
  ...
  #endif
#else
  #define SPINDLE_ENABLE_BIT    PORTB4  // Uno Digital Pin 12
/*------A4--------*/  
  #define my_SPINDLE_ENABLE_DDR    DDRC
  #define my_SPINDLE_ENABLE_PORT   PORTC
  #define my_SPINDLE_ENABLE_PIN    PINC
  #define my_SPINDLE_ENABLE_BIT_1    PORTC4  // Uno Analog Pin 4
   
  #define my_SPINDLE_ENABLE_BIT_2   PORTC3
  #define my_SPINDLE_ENABLE_BIT_3   PORTB5
 /*------A4--------*/
